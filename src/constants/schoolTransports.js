import childToSchoolImage1 from "../assets/childToSchool__schoolTransports_1.jpg";
import childToSchoolImage2 from "../assets/childToSchool__schoolTransports_2.jpg";
import sbCoaster from "../assets/sbCoaster.png";
import sbAsokLeyland from "../assets/sbAsokLeyland.png";

export const schoolTransports = {
  services: [
    {
